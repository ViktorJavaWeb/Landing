var slidersNum = 0,
  sliderElements = document.querySelectorAll('.carousel-list \n\ .carousel-element'),
...
$('a.top').click(
    function(e)
    {
      e.preventDefault(); //Сброс стандартной реакции
      $(document.body).animate(
          {
            scrollTop : 0 //Анимируем скролл вверх
          },
          8000 //Скорость анимации (милисекунд : 0.8 сек.)
      );
    }
);

//===== КОНЕЦ Кнопка "Вверх" на jQuery======
